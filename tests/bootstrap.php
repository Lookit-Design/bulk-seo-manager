 ...
 */
function _lookit_bulk_seo_manager_load_plugin() {
	require dirname( __DIR__ ) . '/lookit-bulk-seo-manager.php';
}
tests_add_filter( 'muplugins_loaded', '_lookit_bulk_seo_manager_load_plugin' );
